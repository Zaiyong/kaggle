...
def loadTrain(train_file,test_file):
    ...
    train_X_df, test_X_df, train_Y_df, test_Y_df=train_test_split(sub_df.iloc[:,1:],sub_df['label'],test_size=0.2,stratify=sub_df['label'])
...
if __name__=='__main__':
    train_X,train_Y,test_X,test_Y=loadTrain('./train.csv','./test.csv')
    # print('train svm')
